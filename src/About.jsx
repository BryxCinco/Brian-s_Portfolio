...
const About = () => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen text-slate-900 dark:text-blue-50 pt-20 sm:pt-24 lg:pt-32 pb-20 px-4 sm:px-6 lg:px-12 overflow-hidden relative transition-colors duration-500"
    >
      
      <div className="max-w-[1400px] mx-auto space-y-20 sm:space-y-32">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-center">
          ...
          >
            <div className="inline-flex items-center justify-center lg:justify-start gap-3 px-4 py-2 bg-[#00b4ff]/10 border border-[#00b4ff]/20 rounded-md text-[#00b4ff] dark:text-[#00e5ff] text-xs font-black uppercase tracking-widest">
              <User size={14} /> More Things About Me
            </div>
            <h1 className="text-5xl sm:text-6xl md:text-8xl font-black tracking-tighter leading-none text-slate-900 dark:text-white">
              Behind the <span className="text-[#00b4ff]">Pixels.</span>
            </h1>
            <p className="text-lg sm:text-xl md:text-2xl text-slate-600 dark:text-blue-100/70 font-medium leading-relaxed max-w-3xl mx-auto lg:mx-0">
            ...
            <div className="flex flex-wrap justify-center lg:justify-start gap-4 sm:gap-6 text-xs sm:text-sm font-black uppercase tracking-widest text-slate-500 dark:text-blue-300/60">
          ...
          >
            <div className="relative z-10 rounded-md overflow-hidden border-2 border-[#00b4ff]/30 rotate-3 hover:rotate-0 transition-transform duration-700 aspect-square shadow-2xl w-full max-w-[400px] lg:max-w-none">
        ...
        <ScrollReveal>
          <section className="space-y-10 sm:space-y-16">
            <div className="flex items-center gap-4 sm:gap-6">
              <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white">Academic Roadmap</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              {academicTimeline.map((item, i) => (
                <motion.div 
                  key={i} 
                  whileHover={{ y: -10 }}
                  className="bg-white/40 dark:bg-white/5 backdrop-blur-md border border-[#00b4ff]/10 rounded-md p-6 sm:p-8 hover:border-[#00b4ff]/40 transition-all group relative overflow-hidden shadow-sm"
                >
                  ...
                  <h4 className="text-base sm:text-lg font-black mb-2 text-slate-900 dark:text-white">{item.year}</h4>
                  <p className="text-[10px] sm:text-xs font-black text-slate-500 dark:text-white/40 uppercase mb-4 tracking-tighter">{item.project}</p>
                  <p className="text-xs sm:text-sm text-slate-600 dark:text-white/60 leading-relaxed mb-6">{item.desc}</p>
                  <div className="pt-4 border-t border-[#00b4ff]/10 flex items-start gap-2">
                    <Star size={14} className="text-yellow-500 shrink-0 mt-1" />
                    <p className="text-[10px] sm:text-[11px] font-bold text-slate-700 dark:text-blue-200 italic">{item.achievement}</p>
                  </div>
                </motion.div>
              ))}
            </div>
        ...
        <ScrollReveal>
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-md border border-[#00b4ff]/10 rounded-md p-6 sm:p-10 md:p-14 space-y-8 sm:space-y-10 shadow-lg">
              <div className="flex justify-between items-center">
                <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white">Work Experience</h3>
              ...
              <div className="space-y-10 sm:space-y-12">
                {experiences.map((exp, i) => (
                  <div key={i} className="relative pl-8 border-l-2 border-[#00b4ff]/20 group">
                    ...
                    <h4 className="text-lg sm:text-xl font-black mb-1 text-slate-900 dark:text-white">{exp.role}</h4>
                    <p className="text-xs sm:text-sm font-bold text-slate-500 dark:text-white/60 mb-4">{exp.company}</p>
                    <p className="text-xs sm:text-sm text-slate-600 dark:text-white/70 leading-relaxed mb-4">{exp.desc}</p>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-gradient-to-br from-[#0088ff] to-[#004080] rounded-md p-6 sm:p-10 md:p-14 text-white shadow-xl relative overflow-hidden group">
                ...
                <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tighter italic mb-6">Key Achievements</h3>
                <div className="space-y-4 sm:space-y-6 relative z-10">
                  {[
                    ...
                    <div key={i} className="flex items-center gap-4">
                      <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-md flex items-center justify-center shrink-0">
                        <Star size={18} className="text-yellow-400" />
                      </div>
                      <p className="font-bold text-sm sm:text-lg">{text}</p>
                    </div>
                  ))}
                </div>
              </div>

              <div className="bg-white/40 dark:bg-white/5 border border-[#00b4ff]/10 rounded-md p-6 sm:p-10 grid grid-cols-2 gap-4 sm:gap-6">
                 <div className="space-y-2">
                    <ShieldCheck className="text-[#00b4ff] dark:text-[#00e5ff] mb-4" />
                    <p className="text-[10px] sm:text-xs font-black uppercase text-slate-400 dark:text-white/40">Focus</p>
                    <p className="text-sm sm:text-base font-black text-slate-900 dark:text-white">Cybersecurity & Auth</p>
                 </div>
                 <div className="space-y-2">
                    <Code2 className="text-[#00b4ff] dark:text-[#00e5ff] mb-4" />
                    <p className="text-[10px] sm:text-xs font-black uppercase text-slate-400 dark:text-white/40">Style</p>
                    <p className="text-sm sm:text-base font-black text-slate-900 dark:text-white">Clean & Scalable</p>
                 </div>
              </div>
            </div>
          </section>
        ...
        {/* MISSION STATEMENT */}
        <ScrollReveal>
          <section className="text-center py-12 sm:py-20 relative px-2">
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black tracking-tighter mb-6 sm:mb-8 italic leading-tight text-slate-900 dark:text-white">
              "Coding with <span className="text-[#00b4ff]">purpose</span>, <br className="hidden sm:block" />designing for <span className="text-[#00b4ff]">people</span>."
            </h2>
            <p className="text-sm sm:text-lg text-slate-600 dark:text-white/60 max-w-2xl mx-auto font-medium leading-relaxed">
        ...
        <ScrollReveal>
          <section className="space-y-10 sm:space-y-16 pb-12 sm:pb-20">
            <div className="flex items-center gap-4 sm:gap-6">
              <h3 className="text-2xl sm:text-3xl font-black uppercase tracking-tighter italic text-slate-900 dark:text-white">My Socials</h3>
              <div className="h-[1px] flex-1 bg-[#00b4ff]/20"></div>
              ...
              {projectShowcase.map((project, i) => (
                ...
                >
                  <a 
                    ...
                    className="relative mx-auto border-gray-900 dark:border-black bg-gray-900 border-[10px] rounded-[3.2rem] h-[600px] sm:h-[750px] w-[300px] sm:w-[350px] shadow-2xl transition-all duration-500 group-hover:-translate-y-4 group-hover:scale-105 group-hover:shadow-[#00b4ff]/40 cursor-pointer block"
                  >
                  ...
                  <div className="mt-20 text-center space-y-2">
                    <h4 className="text-lg sm:text-xl font-black text-slate-900 dark:text-white uppercase tracking-tighter">{project.name}</h4>
                    <p className="text-[10px] sm:text-xs font-black text-[#00b4ff] dark:text-[#00e5ff] uppercase tracking-widest">{project.tech}</p>
                  </div>
                </motion.div>
              ))}
            </div>
